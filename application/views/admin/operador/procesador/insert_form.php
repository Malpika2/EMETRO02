...
<?php }?>
<form method="POST" name="form1" action="<?php echo site_url('operadores/registrar/procesador');?>">
<input type="hidden" name="categoria" value="procesador">
<h4>Formulario de registro, Procesador</h4>
