...
<?php }?>
<form method="POST" name="form1" action="<?php echo site_url('operadores/registrar/ganaderia');?>">
<input type="hidden" name="categoria" value="ganaderia">
<h4>Formulario de registro, Ganaderia</h4>
