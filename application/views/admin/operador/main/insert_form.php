...
<?php }?>
<form method="POST" name="form1" action="<?php echo site_url('operadores/registrar/');?>">
<input type="hidden" name="categoria" value="<?php echo $categoria;?>">
<hr />
<div class="lead"><strong>Agregar registro</strong></div>
<hr />
          <table class="table table-condensed" align="center">
            <!--<tr><td colspan="2"><p>Insertar</p></td></tr>04/03/16-->
            <tr valign="baseline">
              <td nowrap align="right"><p>Nombre de la empresa:</p></td>
              <td><input type="text" class="form-control" name="operador" value="" size="32" required autofocus></td>
              <td nowrap align="right"><p>Nombre del representante legal:</p></td>
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" class="form-control" name="tipo_persona" value="PERSONA MORAL" size="32" ></td>
            </tr>
            <tr valign="baseline">
            	<td nowrap align="right"><p>Nombre de la huerta:</p></td>
              <td><input type="text" class="form-control" name="nombre_huerta" value="" size="32" ></td>
              <td></td><td></td>
            </tr>
            <tr valign="baseline">
