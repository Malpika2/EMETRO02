  ...
  <?php }?>
  <form method="POST" name="form1" action="<?php echo site_url('operadores/detalle/'.$operador->idoperador);?>">
  <div class="lead"><strong>Actualizar operador</strong></div>
  <hr />
          <table class="table-condensed">
            <!--<tr><td colspan="2"><p>Insertar</p></td></tr>04/03/16-->
            <tr valign="baseline">
              <td nowrap align="right"><p>Operador:</p></td>
              <td><input type="text" class="form-control" name="operador" value="<?php echo $operador->operador;?>" size="32" required autofocus></td>
              <td nowrap align="right"><p>Representante legal:</p></td>
              <td><input type="text" class="form-control" name="representante_legal" value="<?php echo $operador->representante_legal;?>"></td>
            </tr>
            <tr valign="baseline">
              <td nowrap align="right"><p>Nombre de huerta(s):</p></td>
              <td><input type="text" class="form-control" name="nombre_huerta" value="<?php echo $operador->nombre_huerta;?>"></td>
              <td colspan="2"></td>
            </tr>
            <tr valign="baseline">
              <td nowrap align="right"><p>Codigo_operador:</p></td>
              <td><input type="text" class="form-control" name="codigo_operador" value="<?php echo $operador->codigo_operador;?>" size="32" required></td>
              <td nowrap align="right"><p>Tipo_persona:</p></td>
              <td><input type="text" class="form-control" name="tipo_persona" value="<?php echo $operador->tipo_persona;?>" size="32" ></td>
            </tr>
            <tr valign="baseline">
            ...
            <tr valign="baseline">
              ...
              <td>
                <input type="text" class="form-control" name="pais" value="<?php echo $operador->pais;?>" >
              </td>
            </tr>
            <tr valign="baseline">
              ...
              <td><input type="text" class="form-control" name="web" value="<?php echo $operador->web;?>" size="32" ></td>
            </tr>
            <tr>
