...
<?php }?>
<form method="POST" name="form1" action="<?php echo site_url('operadores/registrar/comercializador');?>">
<input type="hidden" name="categoria" value="comercializador">
<h4>Formulario de registro, Comercializador</h4>
          <table class="table table-condensed" align="center">
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" class="form-control" name="codigo_operador" value="" size="32" required></td>
              <td nowrap align="right"><p>Tipo_persona:</p></td>
              <td><input type="text" class="form-control" name="tipo_persona" value="" size="32" ></td>
            </tr>
            <tr valign="baseline">
              ...
              <td><input type="text" class="form-control" name="curp" value="" size="32" ></td>
            </tr>
            <tr valign="baseline">
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" class="form-control" name="fax" value="" size="32" ></td>
