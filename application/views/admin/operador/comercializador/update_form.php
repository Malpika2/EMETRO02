...
<h4>Actualización de registro</h4>
          <table class="table table-condensed" align="center">
            ...
            <tr valign="baseline">
              ...
              <td nowrap align="right"><p>CURP:</p></td>
              <td><input type="text" class="form-control" name="curp" value="<?php echo $operador->curp;?>" size="32" ></td>
            </tr>
            <tr valign="baseline">
            ...
            <tr valign="baseline">
              <td nowrap align="right"><p>Fax:</p></td>
              <td><input type="text" class="form-control" name="fax" value="<?php echo $operador->fax;?>" size="32" ></td>
